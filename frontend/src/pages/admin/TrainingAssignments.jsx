  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Training Assignments & Governance</h1>
                ...
                {assignments.map((a) => (
                  <tr key={a.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="px-4 py-3.5 text-slate-600">
                      ...
                      <p className="text-xs text-slate-400">{a.user?.orgRole?.name || 'No Role'}</p>
                    </td>
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <select
                        ...
                        className="px-2 py-1 text-xs font-semibold rounded-md border border-slate-200 bg-white"
                      >
                        <option value="ASSIGNED">Assigned</option>
                        <option value="IN_PROGRESS">In Progress</option>
                        <option value="COMPLETED">Completed</option>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {assignmentMode === 'SINGLE' ? (
                <div>
                  ...
                  {errors.userId && (
                    <p className="text-xs text-rose-500 mt-1">{errors.userId.message}</p>
                  )}
                </div>
              ) : (
                <div>
